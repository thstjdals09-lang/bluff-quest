import { getEventById, resolveEventText } from '../game/content/events';
 ...
 */
export function EventScene(props: { eventId: string; playerName: string; flags?: Record<string, unknown>; onClose: () => void }) {
  ...
  return (
    <div className="event-scene">
      <div className="event-card">
        ...
        <p className="event-text">{fill(resolveEventText(ev, props.flags ?? {}))}</p>
